...
(
    ...
    #9
    ("6=3/8", "{'SPEED':MAX_SPD}", "1++,1+:3+,3:7+,7=1/8"),
    ("6+,6=3/8", "{'SPEED':MIN_SPD}", "0=1/4", "7-=1/8"),
...
(
    ...
    #9
    ("0=3/8", "{'SPEED':MAX_SPD}", "3-,7--=1/4", "{'SPEED':MIN_SPD}","3-,7--,3--=1/8"),
    ("{'SPEED':MAX_SPD}", "6--,6---=1/8","{'SPEED':MIN_SPD}", "3-:7-:3,1:3-=1/8", "{'SPEED':MAX_SPD}", "6--,6---=1/8", ),
    ("6--,6---=1/8", "{'SPEED':MIN_SPD}", "3-:7-:3,1:3-=1/8", "{'SPEED':MIN_SPD}","5--,5---=1/8",),
    ("4--,4---=1/8", "{'SPEED':MIN_SPD}", "1-:4-:1,6-:4-=1/8","{'SPEED':MAX_SPD}", "4--,4---=1/8",),

    #13
    ("4--,4---=1/8", "{'SPEED':MIN_SPD}", "1-:4-:1,6-:4-=1/8", "{'SPEED':MAX_SPD}", "3--,3---=1/8",),
    ("2--,2---=1/8", "{'SPEED':MIN_SPD}", "6--:4-:4,1:4-=1/8", "{'SPEED':MAX_SPD}", "4--,4---=1/8",),
    ("3--,3---=1/8", "{'SPEED':MIN_SPD}", "7--:5-:2,7-:5-=1/8", "{'SPEED':MAX_SPD}","5--,5---=1/8",),
    ("4--,4---=1/8", "{'SPEED':MIN_SPD}", "1-:5-:6-:1=1/8", "{'SPEED':MAX_SPD}","4--,4---=1/8",),

    #17
    ("{'SPEED':MIN_SPD}","4--,4---=1/2", "0=1/4"),
    ("6--:3-:6-:1:6-:3-=1/8",),
    ("6--:3-:6-:1:6-:3-=1/8",),
    ("2--:2-:4-:6-:4-:2-=1/8",),
